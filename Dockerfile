...
RUN mkdir -p /var/log/utility-service && \
    chmod -R 777 /var/log/utility-service  # Ensure the app can write to the log directory
...
# docker push simranarora264/utility-service:latest
